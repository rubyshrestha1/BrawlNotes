...
class PlayerRegistryTest(TestCase):
    ...
    the object's 'Region' field matches with the given value, which in this case it should pass. If they do not match, message that says 'Region is not
    same' is displayed."""
    ...
    """This function tests the region field of the PlayerRegistry table. A new player object is created 
       ...
       the object's 'Region' field matches with the given value, which in case should fail. If they do not match, message that says 'Region is not
       same' is displayed."""
...
class OfficialEventsTest(TestCase):
    ...
    # However, the function gives "object does not exist error" because with get method it is trying to access something that has not been created at all.
...
class PlacementsTest(TestCase):
    ...
    # This function tests the PowerRank field of Placement_1 table. It creates an object of table with the given input PowerRank
